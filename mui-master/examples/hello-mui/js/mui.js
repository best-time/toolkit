...
var mui = (function(document, undefined) {
	...
	var idSelectorRE = /^#([\w-]+)$/; // id选择器
	var classSelectorRE = /^\.([\w-]+)$/; //class选择器
	...
	var $ = function(selector, context) {
		...
		if (typeof selector === 'function')  //是函数  直接运行
	...
	/**
	 * 将 fn 缓存一段时间后, 再被调用执行
	 * 此方法为了避免在 ms 段时间内, 执行 fn 多次.
	 * 常用于 resize , scroll , mousemove 等连续性事件中;
