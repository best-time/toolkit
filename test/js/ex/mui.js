...
var mui = (function(document, undefined) {
    ...
    var idSelectorRE = /^#([\w-]+)$/; //id 正则
    var classSelectorRE = /^\.([\w-]+)$/;  //class 正则
    ...
    $.qsa = function(selector, context) {
        ...
        return $.slice.call(classSelectorRE.test(selector) ?
            ...
            tagSelectorRE.test(selector) ? context.getElementsByTagName(selector) : context.querySelectorAll(selector)
        );
    };
    /**
