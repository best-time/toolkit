(function(root, factory) {
    ...
    function Layzr(options) {
        // debounce
        this._lastScroll = 0; //上次滚动的离顶部的位置
        this._ticking = false;
        ...
        // properties
        this._retina = window.devicePixelRatio > 1; //是否是 retina 显示屏
    ...
    Layzr.prototype._requestScroll = function() {
        this._lastScroll = window.scrollY || window.pageYOffset; //y轴距离顶部距离
        this._requestTick();
    };
...
console.debug("viewportTop: " + viewportTop +
