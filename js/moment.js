...
console.log(factory().fn)
    typeof exports === 'object' && typeof module !== 'undefined'  //服务器模式
	? 
		module.exports = factory() 
	:
		typeof define === 'function' && define.amd   //AMD 模式
		? 
			define(factory) 
			:
			global.moment = factory();   //浏览器模式
    ...
    momentPrototype__proto.toString     = toString;						// moment() 输出的时候调用了 toString
    momentPrototype__proto.unix         = unix;
    momentPrototype__proto.valueOf      = to_type__valueOf;				//计算的时候调用 valueOf()
    ...
    utils_hooks__hooks.fn                    = momentPrototype;   // 包含了 Moment.prototype 中的所有方法
