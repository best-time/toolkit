...
(function() {
    ...
    function runInContext(context) {
        ...
        function baseIntersectionBy(arrays, iteratee) {
            ...
            while (othIndex--) {
                ...
                if (othIndex && iteratee) {
                    array = arrayMap(array, function(value) {
                        return iteratee(value);
                    });
                }
        ...
        function baseMergeDeep(object, source, key, mergeFunc, customizer, stack) {
            ...
            if (isCommon) {
                ...
                if (isArray(srcValue) || isTypedArray(srcValue)) {
                    newValue = isArray(oldValue) ? oldValue : ((isArrayLikeObject(oldValue)) ? copyArray(oldValue) : baseClone(srcValue));
                } else if (isPlainObject(srcValue) || isArguments(srcValue)) {
                    newValue = isArguments(oldValue) ? toPlainObject(oldValue) : (isObject(oldValue) ? oldValue : baseClone(srcValue));
                } else {
        ...
        function baseSlice(array, start, end) {
            ...
            start = start == null ? 0 : toInteger(start); //start没有传,默认0
            if (start < 0) {
                start = -start > length ? 0 : (length + start);
            }
            end = (end === undefined || end > length) ? length : toInteger(end);
        ...
        function baseXorBy(arrays, iteratee) {
            ...
            while (++index < length) {
                var result = result ? arrayPush(baseDifferenceBy(result, arrays[index], iteratee), baseDifferenceBy(arrays[index], result, iteratee)) : arrays[index];
            }
        ...
        function createWrapper(func, bitmask, thisArg, partials, holders, argPos, ary, arity) {
            ...
            newData[9] = arity == null ? (isBindKey ? 0 : func.length) : nativeMax(arity - length, 0);
        ...
        function equalArrays(array, other, equalFunc, customizer, bitmask, stack) {
            ...
            while (++index < arrLength) {
                ...
                if (customizer) {
                    var result = isPartial ? customizer(othValue, arrValue, index, other, array, stack) : customizer(arrValue, othValue, index, array, other, stack);
                }
                if (result !== undefined) {
                    if (result) {
                        continue;
        ...
        function equalObjects(object, other, equalFunc, customizer, bitmask, stack) {
            ...
            while (++index < objLength) {
                ...
                if (customizer) {
                    var result = isPartial ? customizer(othValue, objValue, key, other, object, stack) : customizer(objValue, othValue, key, object, other, stack);
                }
                // Recursively compare objects (susceptible to call stack limits).
                if (!(result === undefined ? (objValue === othValue || equalFunc(objValue, othValue, customizer, bitmask, stack)) : result)) {
                    return false;
                }
        ...
        if ((Map && getTag(new Map) != mapTag) || (Set && getTag(new Set) != setTag)) {
            getTag = function(value) {
                ...
                return ctorString == mapCtorString ? mapTag : (ctorString == setCtorString ? setTag : result);
            };
        }
        ...
        function initCloneArray(array) {
            var length = array.length,
                result = new array.constructor(length); //相当于: Array(length)
        ...
        var differenceBy = rest(function(array, values) {
            ...
            return isArrayLikeObject(array) ? baseDifferenceBy(array, baseFlatten(values, false, true), getIteratee(iteratee)) : [];
        });
        ...
        var intersectionBy = rest(function(arrays) {
            ...
            return (mapped.length && mapped[0] === arrays[0]) ? baseIntersectionBy(mapped, getIteratee(iteratee)) : [];
        });
        ...
        function uniqBy(array, iteratee) {
            return (array && array.length) ? baseUniqBy(array, getIteratee(iteratee)) : [];
        }
        ...
        function includes(collection, target, fromIndex, guard) {
            ...
            return isString(collection) ? (fromIndex <= length && collection.indexOf(target, fromIndex) > -1) : (!!length && baseIndexOf(collection, target, fromIndex) > -1);
        }
        ...
        function reduce(collection, iteratee, accumulator) {
            ...
            return (typeof iteratee == 'function' && isArray(collection)) ? arrayReduce(collection, iteratee, accumulator, initFromCollection) : baseReduce(collection, getIteratee(iteratee, 4), accumulator, initFromCollection, baseEach);
        }
        ...
        function reduceRight(collection, iteratee, accumulator) {
            var initFromCollection = arguments.length < 3;
            return (typeof iteratee == 'function' && isArray(collection)) ? arrayReduceRight(collection, iteratee, accumulator, initFromCollection) : baseReduce(collection, getIteratee(iteratee, 4), accumulator, initFromCollection, baseEachRight);
        }
        ...
        function endsWith(string, target, position) {
            ...
            position = position === undefined ? length : clamp(toInteger(position), 0, length);
