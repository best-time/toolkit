<template>
    <div class="wechatImg">
        <img v-for="img of imgs" class="small-img" :src="img.src" @click="zoomImg($index)" alt="img"/>

        <div class="shadow-box" :style="{display:parameter}">
            <!--遮罩-->
            <div class="shadow" @click="hiddenImg" v-if="show" transition="fade"></div>
            <!--图片-->
            <img class="big-img" :src="imgSrc" v-if="show" :transition="imgZoom" alt="图片">
        </div>
