...
<div class="list">
    ...
    <div class="bd">
        ...
        <div class="weui_cells weui_cells_access">
            <router-link to="comDemo">
            <a class="weui_cell" :to="{path:'/comDemo' , activeClass:'active'}">
                <span class="weui_cell_bd weui_cell_primary">组件通信</span>
                <span class="weui_cell_ft"></span>
            </a>
            </router-link>
            <a class="weui_cell" :to="{path:'/dataBind' , activeClass:'active'}">
                <span class="weui_cell_bd weui_cell_primary">双向数据绑定</span>
                <span class="weui_cell_ft"></span>
            </a>
            <a class="weui_cell" :to="{path:'/conditionRouter' , activeClass:'active'}">
                <span class="weui_cell_bd weui_cell_primary">根据条件跳转路由</span>
                <span class="weui_cell_ft"></span>
            </a>
            <a class="weui_cell" :to="{path:'/wechatImg' , activeClass:'active'}">
                <span class="weui_cell_bd weui_cell_primary">模仿微信点击图片放大</span>
                <span class="weui_cell_ft"></span>
            </a>
            <a class="weui_cell" :to="{path:'/table' , activeClass:'active'}">
                <span class="weui_cell_bd weui_cell_primary">Vue实现自定义表格</span>
                <span class="weui_cell_ft"></span>
            </a>
            <a class="weui_cell" :to="{path:'/inputCheck' , activeClass:'active'}">
                <span class="weui_cell_bd weui_cell_primary">input框检查</span>
                <span class="weui_cell_ft"></span>
            </a>
            <a class="weui_cell" :to="{path:'/propsdata' , activeClass:'active'}">
                <span class="weui_cell_bd weui_cell_primary">todoList Demo</span>
                <span class="weui_cell_ft"></span>
            </a>
            <a class="weui_cell" :to="{path:'/routerdata' , activeClass:'active'}">
        ...
        <div class="weui_panel weui_panel_access weui_cells_access">
            <div class="weui_panel_bd">
                <a v-for="list_item in list_items" :to="{path:'/detail' , activeClass:'active'}" class="weui_media_box weui_media_appmsg weui_cells_access">
