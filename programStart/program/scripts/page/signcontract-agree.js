compose.require('scripts/page/signcontract-agree.js', [
    'window.$',
    "scripts/lib/exp.js",
	...
	var pageConfig = {
			route: {
				'signcontract-agree': 'launch'
			},
			templateName: 'signcontract-agree'
		},
	...
	var view = new eBase.PageView({
		...
		render: function(params, status) {
			...
			headerMenu.setPageTitle(this.el.find('header'), '快捷支付服务与相关协议');
		}
	});
