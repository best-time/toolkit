;(function($, undefined) {
  $.fn.drawDoughnutChart = function(data, options) {
    ...
    var $svg = $('<svg width="' + W + '" height="' + H + '" viewBox="0 0 ' + W + ' ' + H + '"></svg>').appendTo($this),
        $paths = [],
    ...
    if(settings.setSummaryNumber !== false){
    ...
    function drawPieSegments (animationDecimal) {
      ...
      drawDoughnutText(animationDecimal, data[0].value);
