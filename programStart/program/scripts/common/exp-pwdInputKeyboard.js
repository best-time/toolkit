 ...
 * @author mawei
 */
compose.require('scripts/common/exp-pwdInputKeyboard.js', [
    'window.$',
    "scripts/lib/exp.js"
], function($, Exp) {
	...
	Exp.doubleClick = function($el, selector, handler, immediate, data){
		...
		this.touchstart($el, selector, function(event){
			...
			var target = this;
			timer = Exp.setTimeout(interval, severalClickTime);
			...
			function interval(){
				...
				//timer = Exp.setTimeout(interval, severalClickTime/10);
			}
		});
	...
	var keyboard = {
		...
		pwdInputKeyboard: function(options){
			var confirmBtn, keyboard, passwordBox;
			if(!options.passwordBox){
				passwordBox = {
					el: options.el,
					reset: function () {},
				...
				passwordBox = Exp.openPopWindow(getInputTemple(), function(){
				...
				passwordBox.callback = function(value){
		...
		createKeyboard: function(options){
			...
			content.css({
				top: top-el.css("margin-top").match(/\d+/)[0],
				left: left-el.css("margin-left").match(/\d+/)[0],
				width: width,
				height: height,
			...
			var padding = {
				top: (height.match(/\d+/)[0]-fontSize.match(/\d+/)[0])/2,
			...
			function setCuror(char, direct){
				...
				if(char && char.size() && char.hasClass('char') && char.parent().size()){
					left = (paddingLeft.match(/\d+/)[0]-0)+Exp.getLeft(char[0])-0+(direct==='left'?0:char.width());
					top = padding.top;
			...
			var contentSpread = {
				...
				spread: function(input, target){
					...
					if(subY > 0){
						...
						Exp.setTimeout(function(){
							Exp.css(target, 'transform', 'translate3d(0px,'+(realY)+'px,0px)');
			...
			$.extend(keyboardInput, {
				...
				blur: function(forceFlag){
					...
					Exp.setTimeout(function(){contentSpread.shrink(content, $(Exp.createKeyboard.keyboardCore.board.alertBox.el));}, 20);
		...
		numberKeyboard: function(options){
				...
				datas = {
					...
					'text': {
						list:[
							...
							[{text:'',value:'upperCase',width: 44,charClass:'func upper',textClickactive:true},{text:'z',value:'z',magnifier:true},{text:'x',value:'x',magnifier:true},{text:'c',value:'c',magnifier:true},{text:'v',value:'v',magnifier:true},{text:'b',value:'b',magnifier:true},{text:'n',value:'n',magnifier:true},{text:'m',value:'m',magnifier:true},{text:'',value:'delete',charClass:'func',width:44,charClass:'func delete',textClickactive:true}],
							[{text:'!123',value:'mark',width:42,charClass:'func',fontSize:'16',lineHeight:16,textClickactive:true},{text:'.',value:'.',fontSize:'18',lineHeight:18,magnifier:true},{text:',',value:',',fontSize:'18',lineHeight:18,magnifier:true},{text:'space',value:'&nbsp;',flex:9,fontSize:'16',lineHeight:16,textClickactive:'#ADB3BD'},{text:'@',value:'@',fontSize:'16',lineHeight:16,magnifier:true},{text:':',value:':',fontSize:'21',lineHeight:20,magnifier:true},{text:';',value:';',fontSize:'21',lineHeight:20,magnifier:true}],
							[{text:'Q',value:'Q',magnifier:true},{text:'W',value:'W',magnifier:true},{text:'E',value:'E',magnifier:true},{text:'R',value:'R',magnifier:true},{text:'T',value:'T',magnifier:true},{text:'Y',value:'Y',magnifier:true},{text:'U',value:'U',magnifier:true},{text:'I',value:'I',magnifier:true},{text:'O',value:'O',magnifier:true},{text:'P',value:'P',magnifier:true}],
							[{text:'',value:'',charClass:'place',flex:.5},{text:'A',value:'A',magnifier:true},{text:'S',value:'S',magnifier:true},{text:'D',value:'D',magnifier:true},{text:'F',value:'F',magnifier:true},{text:'G',value:'G',magnifier:true},{text:'H',value:'H',magnifier:true},{text:'J',value:'J',magnifier:true},{text:'K',value:'K',magnifier:true},{text:'L',value:'L',magnifier:true},{text:'',value:'',charClass:'place',flex:.5}],
							[{text:'',value:'lowerCase',width: 44,charClass:'func lower',textClickactive:true},{text:'Z',value:'Z',magnifier:true},{text:'X',value:'X',magnifier:true},{text:'C',value:'C',magnifier:true},{text:'V',value:'V',magnifier:true},{text:'B',value:'B',magnifier:true},{text:'N',value:'N',magnifier:true},{text:'M',value:'M',magnifier:true},{text:'',value:'delete',charClass:'func',width:44,charClass:'func delete',textClickactive:true}],
							[{text:'!123',value:'mark',width:42,charClass:'func',fontSize:'16',lineHeight:16,textClickactive:true},{text:'.',value:'.',fontSize:'18',lineHeight:18,magnifier:true},{text:',',value:',',fontSize:'18',lineHeight:18,magnifier:true},{text:'space',value:'&nbsp;',flex:9,fontSize:'16',lineHeight:16,textClickactive:'#ADB3BD'},{text:'@',value:'@',fontSize:'16',lineHeight:16,magnifier:true},{text:':',value:':',fontSize:'21',lineHeight:20,magnifier:true},{text:';',value:';',fontSize:'21',lineHeight:20,magnifier:true}],
							[{text:'1',value:'1',fontSize:'23',magnifier:true},{text:'2',value:'2',fontSize:'23',magnifier:true},{text:'3',value:'3',fontSize:'23',magnifier:true},{text:'4',value:'4',fontSize:'23',magnifier:true},{text:'5',value:'5',fontSize:'23',magnifier:true},{text:'6',value:'6',fontSize:'23',magnifier:true},{text:'7',value:'7',fontSize:'23',magnifier:true},{text:'8',value:'8',fontSize:'23',magnifier:true},{text:'9',value:'9',fontSize:'23',magnifier:true},{text:'0',value:'0',fontSize:'23',magnifier:true}],
							[{text:'~',value:'~',fontSize:'18',lineHeight:18,magnifier:true},{text:'!',value:'!',fontSize:'18',lineHeight:18,magnifier:true},{text:'#',value:'#',fontSize:'18',lineHeight:18,magnifier:true},{text:'$',value:'$',fontSize:'16',lineHeight:16,magnifier:true},{text:'%',value:'%',fontSize:'18',lineHeight:18,magnifier:true},{text:'^',value:'^',fontSize:'21',lineHeight:42,magnifier:true},{text:'&',value:'&',fontSize:'16',lineHeight:16,magnifier:true},{text:'*',value:'*',fontSize:'21',lineHeight:43,magnifier:true},{text:'\'',value:'\'',fontSize:'18',lineHeight:18,magnifier:true},{text:'"',value:'"',fontSize:'18',lineHeight:18,magnifier:true}],
							[{text:'',value:'',charClass:'place',flex:.5},{text:'<',value:'<',fontSize:'18',lineHeight:18,magnifier:true},{text:'>',value:'>',fontSize:'18',lineHeight:18,magnifier:true},{text:'{',value:'{',fontSize:'18',lineHeight:18,magnifier:true},{text:'}',value:'}',fontSize:'18',lineHeight:18,magnifier:true},{text:'[',value:'[',fontSize:'18',lineHeight:18,magnifier:true},{text:']',value:']',fontSize:'18',lineHeight:18,magnifier:true},{text:'=',value:'=',fontSize:'18',lineHeight:18,magnifier:true},{text:'(',value:'(',fontSize:'18',lineHeight:18,magnifier:true},{text:')',value:')',fontSize:'18',lineHeight:18,magnifier:true},{text:'',value:'',charClass:'place',flex:.5}],
							[{text:'英',value:'prev',width:42,charClass:'func',fontSize:'18',lineHeight:18,textClickactive:true,width:45},{text:'+',value:'+',fontSize:'18',lineHeight:18,magnifier:true},{text:'-',value:'-',fontSize:'18',lineHeight:18,magnifier:true},{text:'_',value:'_',fontSize:'18',lineHeight:18,magnifier:true},{text:'`',value:'`',fontSize:'18',lineHeight:18,magnifier:true},{text:'|',value:'|',fontSize:'18',lineHeight:18,magnifier:true},{text:'?',value:'?',fontSize:'18',lineHeight:18,magnifier:true},{text:'',value:'delete',width: 45,charClass:'func',charClass:'func delete',textClickactive:true}]
						],
						pageSize: 4,
						pageIndex: 0,
						marginTop:4,
			...
			var board = Exp.page({
				...
				alertCallBack:function(){
					root = $(this.el);
					var magnifier = $('<svg class="keyboard-char key-magnifier" style="display:none;"><path class="keyboard-char" style="fill:white;stroke:#909397;stroke-width:.3"/><text x="34" y="40" text-anchor="middle" font-family="arial,tahoma" font-size="35" fill="#333"></text></svg>').appendTo(root),
			...
			function changeBoard(type, index){
				...
				function refresh(delay){
					...
					if(delay){
						Exp.setTimeout(refreshData, 20);//400
					}
					else{
						refreshData();
					}
