...
+ function($) {
    ...
    var Picker = function (params) {
        ...
        var originBug = $.device.ios ||
            (navigator.userAgent.toLowerCase().indexOf('safari') >= 0 && navigator.userAgent.toLowerCase().indexOf('chrome') < 0) && !$.device.android;
        ...
        p.initPickerCol = function (colElement, updateItems) {
            ...
            col.wrapper = col.container.find('.picker-items-col-wrapper'); // 滚动区域 外层div
            col.items = col.wrapper.find('.picker-item');       // 滚动区域 item
            ...
            col.wrapper.transform('translate3d(0,' + maxTranslate + 'px,0)').transition(0); // 初始化 选项位置
            ...
            function handleTouchStart (e) {
                ...
                touchStartY =
                    touchCurrentY = e.type === 'touchstart' ? e.targetTouches[0].pageY : e.pageY;

                touchStartTime = (new Date()).getTime();

                allowItemClick = true;
                startTranslate =
                    currentTranslate = $.getTranslate(col.wrapper[0], 'y');
            }
